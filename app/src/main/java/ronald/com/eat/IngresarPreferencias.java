...
public class IngresarPreferencias extends AppCompatActivity implements View.OnClickListener {
    ...
    MainAdapter adapter;
    Button siguiente, regresar, terminar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ingresar_preferencias);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        siguiente=findViewById(R.id.btnSig);
        regresar=findViewById(R.id.btnRegresa);
        terminar=findViewById(R.id.btnFin);
    ...
    public void onClick(View view) {
        ...
        {
            case R.id.btnSig:
                Intent a = new Intent(this,RestringirAlimentos.class);
                startActivity(a);
                break;
            case R.id.btnRegresa:
                Intent b =new Intent(this,InsertarActividades.class);
                startActivity(b);
                break;
            case R.id.btnFin:
                Intent c = new Intent(this,MostrarDieta.class);
                startActivity(c);
                break;
        }
    }
